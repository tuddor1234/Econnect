...
class Training(models.Model):
     ...
     materials=models.FileField(upload_to='resources',null=True)
     img = models.ImageField( default = 'static/default_training.jpg'  ,upload_to = 'trainingsPhoto')
     department = models.CharField(max_length=128, default="No department",null=True)
  
     next_session=models.DateTimeField(max_length=128, blank = True, null=True)
